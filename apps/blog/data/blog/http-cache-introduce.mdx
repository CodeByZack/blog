...
![http-cache-1](https://zackdkblog.oss-cn-beijing.aliyuncs.com/images/http-cache-intoduce/http-cache-1.png)

### 后续请求资源的时候

![http-cache-2](https://zackdkblog.oss-cn-beijing.aliyuncs.com/images/http-cache-intoduce/http-cache-2.png)
